                        ...
                        /* Modification du compte */
                                ...
                                <form method="post" action="./gestionCompte.php">
                                    ...
                                    <fieldset class="form-control my-2">
                                        ...
                                        <?php
                                        /* autorisation découvert si le compte n'est pas un compte intérêt */
                        ...
                        ?>
                            <form method="post" action="./gestionCompte.php">
                                ...
                                <p>
                                    ...
                                    <a href="./gestionCompte.php?action=show&id=<?php ?>"><button class="btn btn-outline-secondary btn-small" type="button">Annuler</button></a>
                                </p>
                            </form>
                        <?php
